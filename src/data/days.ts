...
export const days: DayEntry[] = [
  ...
  { day: 4, title: '88%暴跌、私钥泄露、3000万蒸发：Humanity Protocol崩塌始末', twitterUrl: 'https://x.com/jask_don/status/2064235107427520958', blogUrl: 'https://blog.jask.dev/posts/story-of-humanity-protocol-collapse/' },
  { day: 6, title: '待完成' },
  { day: 7, title: '待完成' },
  { day: 8, title: '待完成' },
  { day: 9, title: '待完成' },
